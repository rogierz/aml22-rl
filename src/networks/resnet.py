...
from torchvision.models import resnet18, mobilenet_v3_small, shufflenet_v2_x0_5
...
class ShuffleNet(BaseFeaturesExtractor):
    ...
    def __init__(self, observation_space: spaces.Box, features_dim: int = 1024, n_frames=3, pre_train=False):
        super().__init__(observation_space, features_dim)
