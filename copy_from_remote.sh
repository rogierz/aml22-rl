...
if [ "$IP" = "20.22.91.51" ] || [ "$IP" = "20.22.152.67" ]; then
    PORT="50001"
fi

if [ "$IP" = "20.88.107.10" ] || [ "$IP" = "20.22.152.67" ] || [ "$IP" = "20.22.91.51" ] || [ "$IP" = "20.85.58.182" ] || [ "$IP" = "20.97.157.108" ]; then
